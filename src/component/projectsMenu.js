class ProjectsMenu extends HTMLElement {
  constructor() {
    super();
    ...
    menu.innerHTML = `
      <div class="main_category block1 right-menu4">
        <a href="/archive/projects/project1.html" class="margin1 hylink1">project #1</a>
        <a href="/archive/projects/project2.html" class="margin1 hylink1">project #2</a>
      </div>
    `;
